...
function HeroSlider({ cars, onSelectCar }) {
  ...
  return (
    <section style={{ position: "relative", width: "100%", height: "100vh", overflow: "hidden", background: "#0a0a0a" }}>
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 5, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 48px 80px" }}>
        <div key={`txt-${cur}`} style={{ maxWidth: 620, animation: "heroTextIn 0.8s cubic-bezier(.25,.8,.25,1) both", animationDelay: "0.15s" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.7)", fontSize: 16, lineHeight: 1.7, margin: "0 0 12px", maxWidth: 480 }}>{car.desc}</p>
